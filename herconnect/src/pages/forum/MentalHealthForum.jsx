...
export default function MentalHealthForum() {
  ...
  const fetchPosts = useCallback(async () => {
    ...
    try {
      const response = await fetch(`${API}/api/forum/posts?filter=${filter}&sort=${sortBy}&category=personal-growth&subcategory=mental-health`, {
        headers: {
      ...
      <div className={styles.forumHeader}>
        <div className={styles.headerContent}>
          <div className={styles.headerText}>
            <h1 className={styles.forumTitle}>💚 Mental Health & Wellbeing</h1>
            <p className={styles.forumSubtitle}>Building confidence, managing stress, and supporting personal growth</p>
      ...
      {!showCreateForm && !editingPost && (
        posts.length === 0 ? (
          <div className={styles.emptyState}>
            <h4 className={styles.emptyTitle}>Create a safe space!</h4>
            <p className={styles.emptySubtitle}>Share your experiences, seek support, or offer encouragement to others</p>
            <button 
              onClick={() => setShowCreateForm(true)}
              className={styles.createPostBtn}
            >
                      ...
                      <div className={styles.commentForm}>
                        <div className={styles.commentInputWrapper}>
                          ...
                          <textarea
                            ...
                            placeholder="Share support or encouragement..."
                            rows="3"
                      ...
                      {post.ForumComments && post.ForumComments.length > 0 ? (
                        <div className={styles.commentsList}>
                          <h6 className={styles.commentsHeader}>
                            💚 Support ({post.ForumComments.length})
                          </h6>
                          {post.ForumComments
