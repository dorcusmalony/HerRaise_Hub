...
export default function CareerForum() {
  ...
  const fetchPosts = useCallback(async () => {
    ...
    try {
      const response = await fetch(`${API}/api/forum/posts?filter=${filter}&sort=${sortBy}&category=personal-growth&subcategory=career-future`, {
        headers: {
      ...
      <div className={styles.forumHeader}>
        <div className={styles.headerContent}>
          <div className={styles.headerText}>
            <h1 className={styles.forumTitle}>💼 Career & Future Opportunities</h1>
            <p className={styles.forumSubtitle}>Internships, career exploration, and professional development</p>
      ...
      {!showCreateForm && !editingPost && (
        posts.length === 0 ? (
          <div className={styles.emptyState}>
            <h4 className={styles.emptyTitle}>Build your future!</h4>
            <p className={styles.emptySubtitle}>Share career opportunities, seek advice, or discuss professional development</p>
            <button 
              onClick={() => setShowCreateForm(true)}
              className={styles.createPostBtn}
            >
                      ...
                      <div className={styles.commentForm}>
                        <div className={styles.commentInputWrapper}>
                          ...
                          <textarea
                            ...
                            placeholder="Share career advice or opportunities..."
                            rows="3"
                      ...
                      {post.ForumComments && post.ForumComments.length > 0 ? (
                        <div className={styles.commentsList}>
                          <h6 className={styles.commentsHeader}>
                            💼 Career Advice ({post.ForumComments.length})
                          </h6>
                          {post.ForumComments
                        ...
                        <div className={styles.noComments}>
                          <p>No comments yet. Be the first to share career advice!</p>
                        </div>
                      )}
                    </div>
                  )}
